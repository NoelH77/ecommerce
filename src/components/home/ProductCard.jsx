...
const ProductCard = ({ product }) => {
  ...
  return (
    <Link
      ...
      className="border-[1px] border-gray-300 rounded-md m-4"
    >
      <div
        className="relative p-4 border-b-[1px] border-gray-300 h-[200px] 
      ...
      <section className="p-4 relative">
        ...
        <h3 className="fotn-bold text-sm ml-2">{product.title}</h3>
        ...
        <button
          ...
          className="absolute right-4 bottom-4 bg-red-500 p-2 text-white 
